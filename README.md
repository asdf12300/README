...
| 명령어 | 주요 기능 | 특징 |
|:------:|:---------:|:----:|
| `top`  | 실시간 시스템 모니터링 | 실시간 갱신, 프로세스 정렬 및 종료 가능 |
| `ps`   | 프로세스 상태 스냅샷 | 특정 시점 상태 확인, 스크립트 자동화에 유용 |
| `jobs` | 백그라운드 작업 관리 | 백그라운드 작업 확인 및 포그라운드 전환 가능 |
| `kill` | 프로세스 종료 | 특정 프로세스 종료, 강제 종료 옵션 지원 |
